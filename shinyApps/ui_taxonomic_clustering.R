      ...
      div(
        ...
        div(class="content",
            fluidRow(
              column(
                width=6,
                textInput("mstring", label="Enter a String:", width="100%"),
                actionButton(
                  "search_string", label="Search", class="mybuttons"
                ),
                actionButton("Helpgo", label="Help", class="mybuttons")
              ),
              column(
                width=6,
                uiOutput("Match")
            ...
            column(
              ...
              div(
                ...
                div(
                  class="content",
                  visNetworkOutput(
                    outputId="dendro", width="auto", height="650px"
            ...
            column(
              ...
              div(
                ...
                div(
                  class="title",
                  HTML(
                    "Cluster Information (&#8593;=Group 1; &#8595;=Group 2)"
                  )
                ),
                div(
                  class="content",
                  tabsetPanel(
                    ...
                    tabPanel(
                      ...
                      fluidRow(
                        column(
                          ...
                          selectInput(
                            "selCov", label=NULL,
                            choices=c("Add Annotation to Heatmap:"="")
                          )
                        ),
                        column(
                          width=12,
                          plotlyOutput(
                            outputId="heatmapPlot", width="auto"
                          ) %>% withSpinner(type=4, color="#0dc5c1")
                        ),
                        column(
                          width=10, offset=1,
                      ...
                      fluidRow(
                        column(
                          ...
                          DT::dataTableOutput(outputId="infoTab") %>%
                            withSpinner(type=4, color="#0dc5c1"),
                          checkboxInput(
                            "viewAll", label="Display all columns", value=FALSE,
                            width="100%"
                          ),
                          br(), br()
                        )
                    ...
                    tabPanel(
                      title="Meta-Variable Results",
                      value="Meta Variable Results",
                      fluidRow(
                        column(
                          width=12,
                          br(),
                        ...
                        column(
                          ...
                          br(),
                          actionButton(
                            "visualizeQvalues", label="Visualize Q-values",
                            class="mybuttons"
                          ),
                          actionButton(
                            "resetQvalues", label="Reset", class="mybuttons"
                          ),
                          br(), br()
                        )
                      )
  ...
  fluidRow(
    ...
    column(
      ...
      div(
        ...
        div(
          class="content",
          plotly::plotlyOutput(outputId="genePlot", width="auto") %>%
            withSpinner(type=4, color="#0dc5c1")
        )
      )
    )
  ...
  fluidRow(
    ...
    column(
      ...
      div(
        ...
        div(
          class="content",
          plotly::plotlyOutput(outputId="pathwayPlot", width="auto") %>%
            withSpinner(type=4, color="#0dc5c1")
        )
      )
    )
