    ...
    bsCollapse(
      ...
      bsCollapsePanel(
        ...
        fluidRow(
          column(
            width=4,
            uiOutput(outputId = "marker_option") %>%
              withSpinner(type=4, color="#0dc5c1", proxy.height="80px")
          ),
          column(
            width=4,
            radioButtons(
              inputId="marker_view",  label="Plot Type:",
              choices=c("Density", "Boxplot"), selected="Density", inline=TRUE
            )
          ),
          column(
            width=4,
        ...
        conditionalPanel(
          ...
          fluidRow(
            column(
              ...
              shinyjs::hidden(
                selectInput(
                  inputId = "marker_gene", label = "Select a gene:",
          ...
          fluidRow(
            column(
              ...
              shinyjs::hidden(
                actionButton(
                  inputId = "de_generate", label = "Generate plot",
                  icon=icon("fas fa-arrow-circle-right"), class="mybuttons"
                )
              )
            )
          )
        ...
        conditionalPanel(
          ...
          fluidRow(
            ...
            column(
              width=4,
              selectInput(
                inputId="marker_gs", label="Select a gene set:",
                choices = c("Please select an option below" = "")
              )
            )
          ),
          fluidRow(
            column(
              ...
              shinyjs::hidden(
                actionButton(
                  inputId = "gs_generate", label = "Generate plot",
                  icon=icon("fas fa-arrow-circle-right"), class="mybuttons"
                )
              )
            )
        ...
        conditionalPanel(
          ...
          fluidRow(
            ...
            column(
              width=4,
              selectInput(
                inputId = "marker_conn", label = "Select a gene set:",
                choices = c("Please select an option below" = "")
              )
            )
          ),
          fluidRow(
            column(
              ...
              shinyjs::hidden(
                actionButton(
                  inputId = "conn_generate", label = "Generate plot",
                  icon=icon("fas fa-arrow-circle-right"), class="mybuttons"
                )
              )
            )
      ...
      fluidRow(
        column(
          ...
          div(
            class="header-3",
            div(class="content",
                plotlyOutput(outputId = "marker_plot_1", width="auto") %>%
